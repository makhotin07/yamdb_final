...
[![API for YaMDB project workflow](https://github.com/makhotin07/yamdb_final/actions/workflows/yamdb_workflow.yml/badge.svg)](https://github.com/makhotin07/yamdb_final/actions/workflows/yamdb_workflow.yml)
...
### Ссылка на сайт
Проект был запущен и доступен по [адресу](http://51.250.72.249/redoc/).
